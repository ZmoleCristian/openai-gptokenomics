...
struct Cli {
    ...
    #[structopt(short = "a", long = "answer", conflicts_with= "request,answer_data,answer_file")]
    answer: bool,
    #[structopt(short = "r", long = "request", conflicts_with= "answer,request_data,request_file")]
    request : bool,
